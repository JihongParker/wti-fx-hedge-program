...
\begin{abstract}
Does mandatory ESG disclosure change how firms hedge? This paper models a firm that jointly chooses hedge ratios and disclosure intensity, with disclosure operating only through the price the firm attaches to residual risk. The model yields closed-form hedge ratios and signed comparative statics, and is tested on Korea's two realized ESG-disclosure mandates -- the governance report, phased in by asset tier over 2019--2024, and the environmental-information requirement binding large issuers from 2022 -- on a 380-firm, 3{,}420 firm-year panel of KOSPI issuers parsed from OpenDART filings. Group-time ATT estimates are precise nulls on both hedging margins for both mandates, with confidence intervals excluding effects beyond roughly six percentage points. The channel is risk-specific: mandates that leave market-risk exposure unquantified leave the hedging incentive unchanged. Korea's climate mandate, which compels that quantification from fiscal 2027 with enforcement phasing in through 2030, is the model's dated forward test.
\end{abstract}
