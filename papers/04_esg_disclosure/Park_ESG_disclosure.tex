...
\centering
\small
\begin{tabular}{l p{2.5cm} p{3.6cm} p{2.9cm}}
\toprule
...
\midrule
\multicolumn{4}{@{}p{13cm}@{}}{\emph{Pilot totals (14 firms):} designation resolved 10/14 (6 applied, 4 not);
numeric note comparable 1/13, heterogeneous 10/13, not located 2/13; one document non-retrievable.} \\
\bottomrule
\end{tabular}
